...
CREATE INDEX IF NOT EXISTS idx_attainment_config_offering
    ON attainment_configurations(course_offering_id);

CREATE INDEX IF NOT EXISTS idx_marks_upload_offering
    ON end_sem_marks_uploads(course_offering_id);

CREATE INDEX IF NOT EXISTS idx_student_co_marks_offering
    ON student_co_marks(course_offering_id);

CREATE INDEX IF NOT EXISTS idx_student_co_marks_student
    ON student_co_marks(student_id);

CREATE INDEX IF NOT EXISTS idx_course_surveys_offering
    ON course_end_surveys(course_offering_id);

CREATE INDEX IF NOT EXISTS idx_programme_exit_survey_batch
    ON programme_exit_surveys(programme_id, batch_id);

CREATE INDEX IF NOT EXISTS idx_uploaded_docs_offering
    ON uploaded_documents(course_offering_id);

CREATE INDEX IF NOT EXISTS idx_uploaded_docs_batch
    ON uploaded_documents(batch_id);

CREATE INDEX IF NOT EXISTS idx_calc_runs_offering
    ON calculation_runs(course_offering_id);

CREATE INDEX IF NOT EXISTS idx_calc_runs_programme_batch
    ON calculation_runs(programme_id, batch_id);

CREATE INDEX IF NOT EXISTS idx_direct_co_attainment_offering
    ON direct_co_attainments(course_offering_id);

CREATE INDEX IF NOT EXISTS idx_indirect_co_attainment_offering
    ON indirect_co_attainments(course_offering_id);

CREATE INDEX IF NOT EXISTS idx_overall_co_attainment_offering
    ON overall_co_attainments(course_offering_id);

CREATE INDEX IF NOT EXISTS idx_po_attainment_programme_batch
    ON po_attainments(programme_id, batch_id);

CREATE INDEX IF NOT EXISTS idx_pso_attainment_programme_batch
