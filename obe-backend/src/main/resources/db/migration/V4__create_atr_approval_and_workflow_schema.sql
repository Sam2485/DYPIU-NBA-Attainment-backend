...
CREATE INDEX IF NOT EXISTS idx_course_atr_offering
    ON course_atrs(course_offering_id);

CREATE INDEX IF NOT EXISTS idx_programme_atr_programme_batch
...
CREATE INDEX IF NOT EXISTS idx_approval_requests_programme_batch
    ON approval_requests(programme_id, batch_id);

CREATE INDEX IF NOT EXISTS idx_approval_requests_offering
...
CREATE INDEX IF NOT EXISTS idx_director_setup_school
    ON director_setup_progress(school_id);

CREATE INDEX IF NOT EXISTS idx_hod_setup_department
    ON hod_setup_progress(department_id);

CREATE INDEX IF NOT EXISTS idx_pc_setup_programme_batch
    ON pc_setup_progress(programme_id, batch_id);

CREATE INDEX IF NOT EXISTS idx_cc_setup_offering
