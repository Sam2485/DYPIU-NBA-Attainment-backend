...
CREATE INDEX idx_attainment_config_course ON attainment_configurations(course_id);
CREATE INDEX idx_student_co_marks_course ON student_co_marks(course_id);
CREATE INDEX idx_student_co_marks_student ON student_co_marks(student_id);
