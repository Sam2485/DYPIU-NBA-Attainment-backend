...
CREATE TABLE IF NOT EXISTS programme_targets (
                                                 id VARCHAR(50) PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS course_co_targets (
                                                 id VARCHAR(50) PRIMARY KEY,
...
CREATE INDEX IF NOT EXISTS idx_mapping_keywords_offering
...
CREATE INDEX IF NOT EXISTS idx_programme_outcomes_programme
    ON programme_outcomes(programme_id);

CREATE INDEX IF NOT EXISTS idx_po_competencies_po
    ON po_competencies(po_id);

CREATE INDEX IF NOT EXISTS idx_programme_pso_programme
    ON programme_specific_outcomes(programme_id);

CREATE INDEX IF NOT EXISTS idx_pso_competencies_pso
    ON pso_competencies(pso_id);

CREATE INDEX IF NOT EXISTS idx_peo_outcomes_programme
    ON peo_outcomes(programme_id);

CREATE INDEX IF NOT EXISTS idx_course_outcomes_offering
    ON course_outcomes(course_offering_id);

CREATE INDEX IF NOT EXISTS idx_co_po_mapping_co
    ON co_po_mappings(course_outcome_id);

CREATE INDEX IF NOT EXISTS idx_co_pso_mapping_co
    ON co_pso_mappings(course_outcome_id);

CREATE INDEX IF NOT EXISTS idx_programme_targets_batch
    ON programme_targets(batch_id);

CREATE INDEX IF NOT EXISTS idx_course_co_targets_course
