...
CREATE INDEX IF NOT EXISTS idx_po_prog ON programme_outcomes(programme_id);
CREATE INDEX IF NOT EXISTS idx_pso_prog ON programme_specific_outcomes(programme_id);
CREATE INDEX IF NOT EXISTS idx_co_course ON course_outcomes(course_id);
CREATE INDEX IF NOT EXISTS idx_co_po_map ON co_po_mappings(course_outcome_id);
CREATE INDEX IF NOT EXISTS idx_co_pso_map ON co_pso_mappings(course_outcome_id);
